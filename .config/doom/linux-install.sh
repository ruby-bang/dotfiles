...
curl -L -O -f -m 120 --connect-timeout 5 --retry 5 --retry-connrefused --retry-max-time 60 --no-progress-meter https://github.com/clojure/brew-install/releases/download/1.12.5.1654/clojure-tools-1.12.5.1654.tar.gz
echo "dc86cc56bc372fcef07bd87f44693eeb4b61cf5f44347883878364d03b5fb342  clojure-tools-1.12.5.1654.tar.gz" | sha256sum -c | grep "^clojure-tools-1.12.5.1654.tar.gz: OK$"
tar xzf clojure-tools-1.12.5.1654.tar.gz
...
install -m644 clojure-tools/clojure-tools-1.12.5.1654.jar "$clojure_lib_dir/libexec/clojure-tools-1.12.5.1654.jar"
...
rm -rf clojure-tools
rm -rf clojure-tools-1.12.5.1654.tar.gz
